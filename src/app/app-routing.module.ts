  ...
  // Admin Components
  {
    ...
    children:
      [
        ...
        { path: 'userManageInvoice', component: UserManageInvoiceComponent, canActivate: [AuthGuard], data: { permittedRoles: ['SuperAdmin'] } },
        { path: 'adminManageInvoice', component: AdminManageInvoiceComponent, canActivate: [AuthGuard], data: { permittedRoles: ['SuperAdmin'] } },
